            ...
            <div className="bg-zinc-50 dark:bg-[#1a1a1a] p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-purple-500/40 transition-all duration-300 hover:-translate-y-1">
              ...
              <ul className="space-y-3 text-zinc-600 dark:text-zinc-400 text-sm">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Building and maintaining enterprise CRM and management
                    systems.
                  </span>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Developing modern, responsive user interfaces with React,
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Designing reusable components and scalable frontend
                    architectures.
                  </span>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Improving application performance, maintainability, and
                    user experience.
                  </span>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Contributing to full-stack development using Laravel and
